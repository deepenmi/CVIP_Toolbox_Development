function x = xorcvip(a,b)

% This function performs a bitwise XOR of two images. Complex data is NOT supported.
...
% Checking number of input arguments    
    if nargin<2,
        error('Too few arguements for xorcvip');
    elseif nargin>2,
        error('Too many arguements for xorcvip');
    end;
%----------------------------------------------------------------
